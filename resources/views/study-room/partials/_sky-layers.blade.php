...
>
    <div
        class="absolute top-[18%] left-[12%] h-3 w-16 animate-drift [animation-duration:500s] {{ $isFocus ? 'scale-[2.5] sm:scale-[3.5]' : '' }}"
    >
        <span
    ...
    <div
        class="absolute top-[42%] left-[58%] h-2.5 w-12 animate-drift [animation-duration:700s] [animation-delay:-300s] {{ $isFocus ? 'scale-[2.5] sm:scale-[3.5]' : '' }}"
    >
        <span
    ...
    <div
        class="absolute top-[8%] left-[78%] h-3.5 w-20 animate-drift [animation-duration:600s] [animation-delay:-467s] {{ $isFocus ? 'scale-[2.5] sm:scale-[3.5]' : '' }}"
    >
        <span
