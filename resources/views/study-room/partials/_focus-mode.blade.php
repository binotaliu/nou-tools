...
<template x-if="focusMode">
    ...
    >
        ...
        <svg
            ...
            aria-hidden="true"
        >
            <circle cx="18" cy="18" r="16" fill="rgba(255,214,130,0.55)" class="transition-opacity duration-1000" style="opacity: var(--c-lamp)" />
            <rect x="22" y="40" width="20" height="4" rx="2" fill="var(--c-desk-bottom)" />
            <rect x="30" y="18" width="3" height="23" rx="1.5" fill="var(--c-desk-bottom)" />
            <rect x="22" y="14" width="3" height="12" rx="1.5" transform="rotate(-50 23.5 20)" fill="var(--c-desk-bottom)" />
            <path d="M6 20 L24 8 L34 20 Z" fill="var(--c-frame)" />
            <circle cx="18" cy="19" r="3" fill="#ffe08a" class="transition-opacity duration-1000" style="opacity: calc(0.3 + 0.7 * var(--c-lamp))" />
        </svg>
    </div>
</template>
