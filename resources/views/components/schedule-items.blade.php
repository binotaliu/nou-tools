...
{{--
    ...
    real, local time (and survive offline caching). The nouToolsScheduleItems
    factory lives in resources/js/schedule-items.js, bundled into app.js.
--}}
<div
    x-data="nouToolsScheduleItems({{ Js::encode($itemsPayload) }})"
