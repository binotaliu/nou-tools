    ...
    >
        ...
        >
            ...
            >
                ...
                <a href="https://support.apple.com/zh-tw/guide/iphone/iph42ab2f3a7/ios" target="_blank" rel="noopener noreferrer" class="underline hover:text-warm-700 dark:hover:text-warm-300">Apple 官方教學</a>中的「將網站圖像加入你的主畫面」章節（可在頁面中選擇你的 iOS 版本）。</p>
