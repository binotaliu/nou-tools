  ...
  <div class="mx-auto max-w-5xl">
    ...
    @if (count($schedule->items) > 0)
      <div class="mb-8">
        ...
        @if ($hasAnyOverride)
          <p class="mb-4 flex items-center gap-1 text-sm text-warm-600">
              ...
              >
                @foreach (collect($monthData['dates'])->sortKeys() as $dateStr => $courses)
                  ...
                  >
                    ...
                    <div class="mb-1 font-semibold text-warm-900">
      ...
      <x-card class="mb-8">
        ...
        <div class="hidden overflow-x-auto md:block">
          <table class="w-full border-collapse overflow-hidden rounded">
            <thead>
              <tr class="rounded-t border-b-2 border-warm-300 bg-warm-100">
