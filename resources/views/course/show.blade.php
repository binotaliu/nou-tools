    ...
    <x-card class="mb-6">
      ...
      <dl class="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        @if ($course->midterm_date || $course->final_date || $course->exam_time_start || $course->exam_time_end)
          <div>
            <dt class="mb-2 font-semibold text-warm-900">考試資訊</dt>
            <dd class="text-warm-700">
                ...
                <div class="mb-2">
                  ...
                  >
                    ...
                    @if ($course->exam_time_start || $course->exam_time_end)
                      <div class="text-sm whitespace-nowrap text-warm-600">
                        @if ($course->exam_time_start && $course->exam_time_end)
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between">
                          <div>
                            ...
                            @if ($class->teacher_name)
                              <div class="mt-1 truncate text-sm text-warm-700">
                                @php
                      ...
                      @if ($class->schedules->isNotEmpty())
                        <div class="mt-2 rounded bg-white p-3">
                          <p class="mb-2 text-sm font-semibold text-warm-900">
                            視訊面授日期：
                          </p>

                          {{-- 列出每一天；只有 schedule 本身有 start_time/end_time (override) 時，才在該日期旁顯示覆寫時間 --}}
                          <div class="space-y-1 text-sm text-warm-700">
                            @php
                      ...
                      @else
                        <p class="mt-2 text-sm text-warm-600">未設定上課時間</p>
                      @endif
                    </div>
                  @endforeach
                </div>
