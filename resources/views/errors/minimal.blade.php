...
<body class="bg-warm-50 text-warm-900 dark:bg-zinc-950 dark:text-zinc-100">
    <header
        class="border-warm-200 sticky top-0 z-40 border-b bg-white dark:border-zinc-700 dark:bg-zinc-900"
    >
        <div class="mx-auto max-w-7xl px-3 py-2 md:px-6 md:py-4">
            <h1
                class="text-warm-700 inline-flex items-center gap-2 text-lg font-bold md:gap-4 md:text-2xl dark:text-zinc-300"
            >
                <x-heroicon-o-book-open
                    class="text-warm-700 size-5 shrink-0 md:size-6 dark:text-zinc-300"
                />
    ...
    <main class="mx-auto max-w-7xl px-6 py-8">
        <div class="flex min-h-[60vh] items-center justify-center">
            <div class="w-full max-w-md">
                <div
                    class="border-warm-200 rounded-lg border bg-white p-8 dark:border-zinc-700 dark:bg-zinc-900"
                >
                    <div class="mb-6 text-center">
                        <h2
                            class="text-warm-600 mb-2 text-4xl font-bold dark:text-zinc-400"
                        >
                            @yield('code')
                        </h2>
                        <p
                            class="text-warm-900 mb-4 text-2xl font-semibold dark:text-zinc-100"
                        >
                            @yield('message')
                        </p>
                        <p class="text-warm-900 dark:text-zinc-100">抱歉，發生了一些問題。如果問題持續，請
                        <a class="text-warm-600 underline hover:no-underline dark:text-zinc-400" href="{{ $mailtoLink }}"> 點擊此連結寫信聯絡網站作者 </a>
                        。</p>
                    </div>
                    ...
                    <div class="flex gap-3">
                        <button
                            id="back-button"
                            class="border-warm-200 text-warm-700 hover:bg-warm-50 flex-1 rounded-md border px-4 py-2 text-center font-medium transition-colors dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-950"
                        >
                            回到上一頁
                        </button>
                        <a
                            href="{{ url('/') }}"
                            class="bg-warm-600 hover:bg-warm-700 flex-1 rounded-md px-4 py-2 text-center font-medium text-white transition-colors"
                        >
                            回到首頁
                        </a>
                    </div>
