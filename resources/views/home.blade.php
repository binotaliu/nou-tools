    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-warm-200 w-full md:w-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-2">
                <a href="https://www.nou.edu.tw" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-3 py-2 text-sm bg-white border border-warm-200 text-warm-700 rounded hover:bg-warm-50 gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                ...
                <a href="https://noustud.nou.edu.tw/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-3 py-2 text-sm bg-white border border-warm-200 text-warm-700 rounded hover:bg-warm-50 gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                ...
                <a href="https://uu.nou.edu.tw/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-3 py-2 text-sm bg-white border border-warm-200 text-warm-700 rounded hover:bg-warm-50 gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
