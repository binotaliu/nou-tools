...
<template>
  ...
  >
    <div
      class="rounded-lg border border-warm-200 bg-white dark:border-zinc-700 dark:bg-zinc-900"
      ...
      >
        ...
        >
          ...
          <div class="text-center">
            <p class="text-xs text-warm-500 tabular-nums dark:text-zinc-400">
              {{ taiwanDateString }}
            </p>
            <p class="text-[0.65rem] text-warm-400 dark:text-zinc-500">
              台灣時間
            </p>
          </div>
        </div>
