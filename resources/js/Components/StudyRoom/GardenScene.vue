...
defineProps({
  ...
  sceneClass: { type: String, required: true },
})
</script>
...
<template>
  <div
    ...
    :style="sky.gardenVars()"
    data-testid="study-room-garden"
  >
    <SkyLayers :sky="sky" sky-layout="garden" />

    <SceneSkyline
      id-prefix="study-room-garden"
      svg-class="absolute inset-x-0 bottom-[30%] h-[46%] w-full"
    />
    ...
    <svg
      class="absolute bottom-[16%] left-[4%] h-[34%] w-auto"
      viewBox="0 0 60 100"
      aria-hidden="true"
    >
    ...
    <svg
      class="absolute bottom-[20%] left-[17%] h-[28%] w-auto"
      viewBox="0 0 60 100"
      aria-hidden="true"
    >
      <rect x="27" y="78" width="6" height="22" rx="2" fill="var(--g-trunk)" />
      <path
        d="M30 0 L56 44 L42 44 L58 82 L2 82 L18 44 L4 44 Z"
        fill="var(--g-pine)"
      />
    </svg>
    <svg
      class="absolute right-[22%] bottom-[19%] h-[24%] w-auto"
      viewBox="0 0 60 100"
      aria-hidden="true"
    >
    ...
    <svg
      class="absolute right-[3%] bottom-[14%] h-[36%] w-auto"
      viewBox="0 0 60 100"
      aria-hidden="true"
    >
    ...
    <svg
      class="absolute bottom-[10%] left-[30%] h-[9%] w-auto"
      viewBox="0 0 80 40"
      aria-hidden="true"
    >
    ...
    <svg
      class="absolute bottom-[14%] left-[58%] h-[34%] w-auto overflow-visible"
      viewBox="0 0 40 100"
      aria-hidden="true"
    >
      <circle
