  ...
  >
    ...
    >
      <a
        ...
        class="flex inline-flex items-center justify-center gap-2 truncate rounded border border-theme-200 bg-white px-3 py-2 text-base text-theme-700 hover:bg-theme-50 md:flex-col dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-950"
      >
    ...
    <div
      v-if="customLinks.length > 0"
      class="mt-4 flex flex-wrap items-start gap-x-4 gap-y-2 rounded border-2 border-dotted border-theme-700/50 px-4 py-2"
    >
      <a
        v-for="link in customLinks"
        :key="link.url"
        :href="link.url"
        class="mb-0 inline-flex items-center justify-center gap-2 rounded-lg border border-theme-500 bg-white px-4 py-2 font-semibold text-theme-900 transition hover:bg-theme-50 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800"
      >
