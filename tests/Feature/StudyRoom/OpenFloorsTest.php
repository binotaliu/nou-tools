...
function occupySeat(int $floor, int $seatNumber): void
{
...
it('keeps only floor 1 open while it has spare seats', function () {
    occupySeat(1, 1);
    occupySeat(1, 2);
...
it('opens floor 2 once floor 1 is completely full', function () {
...
it('opens floor 3 once floors 1 and 2 are both completely full', function () {
...
it('keeps floor 2 open when someone is alone there even though floor 1 has space', function () {
    occupySeat(2, 1);
...
it('respects the floors.max cap even when every floor is completely full', function () {
...
function fillFloorCompletely(int $floor): void
{
