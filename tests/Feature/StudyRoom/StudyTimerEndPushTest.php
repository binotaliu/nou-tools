...
it('notifies a student whose focus timer just ran out', function () {
...
it('notifies when a break timer runs out, not just a focus one', function () {
...
it('stamps the seat so a second sweep stays quiet', function () {
...
it('stays quiet while the timer is paused', function () {
...
it('stays quiet for a student who has not opted in', function () {
...
it('stays quiet for a student with no push subscription', function () {
...
it('stays quiet for a count-up timer, which has no end', function () {
...
it('stays quiet about a timer that ran out long ago', function () {
...
it('stays quiet for a seat nobody is sitting in', function () {
...
it('notifies again once the next round has started', function () {
    [$schedule, $seat] = expiredTimerSeat();
 ...
 */
it('clears the marker when the next timer starts', function (string $route, string $method) {
    [$schedule, $seat] = expiredTimerSeat();
